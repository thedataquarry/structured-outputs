...
class PromptLogger(BaseCallback):
    def on_adapter_format_end(self, call_id, outputs, exception):
        if exception or not outputs:
            return
        # Chat LMs get a messages array; completion models may use "prompt"
...
class ExtractData(dspy.Module):
    ...
    def forward(
        ...
        print("RAW r1:", r1)
        print("patient type:", type(r1.patient))
        print("patient value:", r1.patient)
        r1.patient.record_id = note["record_id"]
        r1 = r1.patient.model_dump()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="../data/structured_output_dspy_toon.json",
